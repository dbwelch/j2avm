 ...
 * @author nickmain
 */
public class ClassTranslatorBase implements ClassTranslator {
    ...
    private final AVM2Namespace packageNamespace;
     ...
     * Get the superclass
     */
    /*pkg*/ ClassTranslatorBase superclass() throws ClassNotFoundException, IOException {
